...
//	float d = max(0, dot(-light_dir, N));
	...
	//	debugs ...
	//out_colour = light_colour;
	//out_colour = normalize(light_dir);
	//out_colour = normal_sample;
	//out_colour = position_sample;
	//out_colour = vec3(0, frag_texcoord);
	//out_colour = vec3(0, d, 0);
	out_colour = vec3(0, 0, 0);
}
